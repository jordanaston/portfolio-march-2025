...
export default function NarBar() {
  ...
  return (
    <motion.nav
      className="fixed top-0 right-0 left-0 flex items-center justify-between px-4 py-[clamp(0.75rem,1vw+0.5rem,1.25rem)] backdrop-blur-sm sm:px-[clamp(0.75rem,5vw+0.5rem,8rem)]"
