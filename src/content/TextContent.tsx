...
export function Info(): TextContentSection {
  return {
    title: "INFO",
    paragraphs: [
      "I started out completing an internship at Moonward Apps in 2023, which gave me solid foundation in modern app development. I currently work at Labrys in Brisbane, where I've been diving deep into blockchain and full-stack web2 development for the past year and a half.",
